...
Также можно отправлять деньги непосредcтвенное через консоль ноды блокчейна (подробнее [здесь](#cmd)) 
...
Осуществлять переводы между счетами можно также через коноль ноды блокчейна. 
